/**
* @Description Aqui se alojan todas las funciones que son usadas por la pagina subContenidos.php
 ...
 */
function deleteRecord(idP, id) {location.href = './subContenidosUpdate.php?method=delete&idP=' + idP + '&id=' + id;}
