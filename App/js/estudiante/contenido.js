/**
* @Description Aqui se alojan todas las funciones que son usadas por la pagina contenido.php del rol estudiante
 ...
 */
function backPrincipalPage() {location.href = location.origin + location.pathname + '?pg=1';}