/**
* @Description Aqui se alojan todas las funciones que son usadas por la pagina subContenido.php del rol estudiante
 ...
 */
function backParentPage(id, file) {location.href = location.origin + location.pathname + '?pg=3&fl=' + file + '&idP=' + id;}