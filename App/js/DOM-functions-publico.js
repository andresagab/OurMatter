...
$(document).ready(function () {
    ...
    $("#btnHome").click(function () {$("#containerFull").load('./App/pages/publico/inicio.html');});
...
function validMessageAlert() {
    if (document.getElementById('toastAction') != null) {
        if ($('#toastAction').val() === '0') $("#textToast").text("Haz intentado iniciar sesión icorrectamente, vuelve a ingresar e intentalo de nuevo.");
